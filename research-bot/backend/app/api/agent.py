        ...
        try:
            ...
            async for event in research_graph.astream_events(
                ...
                # Stream individual LLM tokens 
                    ...
                    # We only stream tokens generated by the "aggregator" node (to avoid flooding the UI with thinking)
                    if metadata.get("langgraph_node") == "aggregator":
                        chunk = event["data"].get("chunk")
                        # If the chunk has actual text content, stream it to the frontend
