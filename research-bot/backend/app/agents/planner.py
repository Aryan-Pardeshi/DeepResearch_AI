...
def planner_node(state: ResearchState):
    ...
    prompt = ChatPromptTemplate([("system","You are a planner agent specialized in breaking down complex research queries into smaller tasks. You must return your response in JSON format with a single key 'sub_tasks' containing a list of strings representing the sub-tasks (at most 5). Keep each task description short and under 15 words. Each task should be independent and cover different aspects of the research query."),
